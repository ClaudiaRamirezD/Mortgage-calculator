const ResultsFilled = ({ monthlyRepayment, totalRepayment }) => {
    ...
    return (
        <section className="results-filled flex flex-col gap-3">
        ...
        <div className="results-table flex flex-col gap-4 bg-[var(--slate-dark)] rounded-md p-4 border-t-4 border-[var(--lime)]">
            <div>
